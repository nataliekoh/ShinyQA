    ...
    mainPanel(#width = 9,
      tabsetPanel(
        ...
        tabPanel("TSNR Images",
                 ...
                 h3("TSNR Mean (e001)"),
                 plotOutput("tsnr.e001x", width = 400),
                 plotOutput("tsnr.e001y", width = 400),
                 plotOutput("tsnr.e001z", width = 400),
                 h3("TSNR Mean (e002)"),
                 plotOutput("tsnr.e002x", width = 400),
                 plotOutput("tsnr.e002y", width = 400),
                 plotOutput("tsnr.e002z", width = 400),
                 h3("TSNR Mean (e003)"),
                 plotOutput("tsnr.e003x", width = 400),
                 plotOutput("tsnr.e003y", width = 400),
                 plotOutput("tsnr.e003z", width = 400)),
