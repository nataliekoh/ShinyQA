...
numvols <- as.numeric(read.csv("PROJECTDIR/subjects/SUBID/sessionNO/TASK/numvols", header = FALSE))
...
<span style="color:red">`r fd.warn.e002`</span>
<span style="color:red">`r fd.warn.tsoc`</span>
<span style="color:red">`r fd.warn.medn`</span>
<span style="color:red">`r dvars.warn.e002`</span>
<span style="color:red">`r dvars.warn.tsoc`</span>
<span style="color:red">`r dvars.warn.medn`</span>
